...
Define_Module(Ieee80211Interleaving);

void Ieee80211Interleaving::initialize(int stage)
{
...
BitVector Ieee80211Interleaving::interleaving(const BitVector deinterleavedBits) const
{
...
BitVector Ieee80211Interleaving::deinterleaving(const BitVector interleavedBits) const
{
